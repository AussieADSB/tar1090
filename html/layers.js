...
function createBaseLayers() {
    ...
    */
    ...
    let cartoBasemaps = [
        {id: "rastertiles/voyager", title: "CARTO Streets"},
        {id: "dark_all", title: "CARTO Dark"},
        {id: "dark_nolabels", title: "CARTO Dark (No Labels)"},
        {id: "light_all", title: "CARTO Light"},
        {id: "light_nolabels", title: "CARTO Light (No Labels)"}
    ]

    {
        for (let i in cartoBasemaps) {
            ...
            basemaps.push(new ol.layer.Tile({
                ...
                name: "carto_" + cartoBasemap.id,
                title: cartoBasemap.title,
                type: 'base',
            }));
        }
    }
...

    {
        ...
        g.refreshRainviewerRadar = async function() {
            ...
            const rainviewerRadarSource = new ol.source.XYZ({
                url: 'https://tilecache.rainviewer.com' + latestLayer.past[latestLayer.past.length - 1].path + '/512/{z}/{x}/{y}/2/1_1.png',
